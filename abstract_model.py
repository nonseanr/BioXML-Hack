...
class AbstractModel(pl.LightningModule):
    def __init__(self,
        ...
        if lr_scheduler_kwargs is None:
            ...
            print("No lr_scheduler_kwargs provided. The default learning rate is 1e-3.")
    ...
    def training_step(self, batch, batch_idx):
        (protein_inputs, text_inputs, sm_inputs), labels = batch

        outputs = self(protein_inputs, text_inputs, sm_inputs)
